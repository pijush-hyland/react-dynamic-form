...
import quoteOptions from './assets/formConfig.current.json';
        ...
        <div className="min-h-screen flex flex-col bg-gray-100 gap-6">
          ...
          <main className="flex-1 container mx-auto px-4">
            <Routes>
              ...
              <Route path="/quote" element={<DynamicForm formConfig={{formGroup: quoteOptions, name: "Get a Shipment Quote", showformStageName: false}}/>} />
            </Routes>
          </main>
